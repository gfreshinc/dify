...
class GoogleLargeLanguageModel(LargeLanguageModel):
    ...
    def _generate(
        ...
        if model_parameters.get("thinking"):
            config.thinking_config = types.ThinkingConfig(
                thinking_budget=model_parameters.get("thinking_budget", 1000),
            )
    ...
    def _upload_file_content_to_google(
        self, message_content: PromptMessageContent,
    ...
    def _parse_parts(self, parts: Sequence[types.Part], /) -> AssistantPromptMessage:
        ...
        for part in parts:
            ...
            if part.function_call:
                ...
                print(f"Generated function call ID: {function_call_id}")
        ...
        message = AssistantPromptMessage(
            content=contents_text, tool_calls=function_calls  # type: ignore
        )
        return message
